...
BASE_PROMPT = """
Evaluate the SENTENCE below about Artificial Intelligence (AI) and decide whether it leans POSITIVE or NEGATIVE.  
- A POSITIVE classification reflects optimism, benefits, or opportunities associated with AI.  
- A NEGATIVE classification includes risks, drawbacks, or a neutral tone without evident positivity.  
...
if __name__=='__main__':
    ...
    output_path = os.path.join('results', 'gpt_labels_c.json')
