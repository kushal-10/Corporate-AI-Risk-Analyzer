...
BASE_PROMPT = """
Review the following SENTENCE about Artificial Intelligence (AI). Is it POSITIVE or NEGATIVE?  
- POSITIVE highlights AI as an advantage, innovation, or source of value.  
- NEGATIVE refers to mentions of risks, challenges, or ambiguous views lacking clear positivity.  

SENTENCE:  
"""

END_PROMPT = """
Respond with only POSITIVE or NEGATIVE, in one word.  
"""
...
if __name__=='__main__':
    ...
    output_path = os.path.join('results', 'gpt_labels_b.json')
